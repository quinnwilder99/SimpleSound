...
**Effective & last updated:** September 16, 2026
...
> like any other source file. If you later move hosting (e.g. to GitHub
> Pages), update both this note and `PRIVACY_POLICY_URL` in `AboutScreen.kt`.
